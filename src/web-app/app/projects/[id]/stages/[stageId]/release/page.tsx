    ...
    return (
      <AppShell>
        <div className="flex min-h-full items-center justify-center py-20">
          <p className="text-sm" style={{ color: "rgba(13,17,68,0.4)" }}>Loading release details…</p>
        </div>
      </AppShell>
    );
  }
      ...
      <AppShell>
        <div className="flex min-h-full items-center justify-center px-6 py-20">
          <div className="text-center max-w-xs">
            ...
            <p className="text-xl font-bold" style={{ color: "var(--brand-navy, #0D1144)" }}>Payment released</p>
    ...
    <AppShell>
      <div className="min-h-full px-4 md:px-8 py-8 max-w-2xl mx-auto">
        ...
        <div className="mt-4 mb-6">
          <h1 className="text-2xl font-bold" style={{ color: "var(--brand-navy, #0D1144)" }}>Release payment</h1>
        ...
        <div className="space-y-5">
          ...
          >
            ...
            {stage?.contractorName && (
              <p className="mt-0.5 text-sm" style={{ color: "rgba(13,17,68,0.5)" }}>{stage.contractorName}</p>
            )}

            <div className="mt-4 grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs" style={{ color: "rgba(13,17,68,0.45)" }}>Contracted value</p>
                <p className="mt-1 text-lg font-bold" style={{ color: "var(--brand-navy, #0D1144)" }}>{gbp.format(stage?.value ?? 0)}</p>
              </div>
              <div>
                ...
                {certifiedAmount !== (stage?.value ?? certifiedAmount) && (
                  <p className="text-[10px] mt-0.5" style={{ color: "#d97706" }}>Certified below contracted value</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {approvals.length === 0 ? (
              ...
              <div className="space-y-2">
                {approvals.map((ap) => {
                  const color = APPROVAL_COLOR[ap.decision] ?? "#6b7280";
                  return (
                    <div
                      key={ap.id}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {ap.notes && (
                          <p className="text-xs italic mt-0.5" style={{ color: "rgba(13,17,68,0.45)" }}>{ap.notes}</p>
                        )}
                      </div>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold" style={{ color: "var(--brand-navy, #0D1144)" }}>{gbp.format(wallet.available)}</span>
                </div>
                ...
                <div
                  ...
                  style={{ borderTop: "1px solid var(--surface-border, #e4e7f0)", color: (afterRelease ?? 0) < 0 ? "#dc2626" : "var(--brand-navy, #0D1144)" }}
                >
          ...
          {!canRelease && (
            ...
            >
              <p className="text-xs font-bold uppercase tracking-wider" style={{ color: "#d97706" }}>Not yet cleared for release</p>
          ...
          {canRelease && (
            <label
              ...
              style={{
                border: `1px solid ${confirmed ? "rgba(5,150,105,0.4)" : "var(--surface-border, #e4e7f0)"}`,
            ...
            >
              ...
              <p className="text-sm" style={{ color: "var(--brand-navy, #0D1144)" }}>
                ...
                <span className="font-bold">{gbp.format(certifiedAmount)}</span>{" "}
                for <span className="font-bold">{stage?.name}</span>.
          ...
          {releaseError && (
            ...
            >
              ...
              <p className="mt-1 text-sm" style={{ color: "#dc2626" }}>{releaseError}</p>
            </div>
          )}
          ...
          {canRelease && (
            <button
              ...
              className="w-full rounded-2xl py-4 text-sm font-bold text-white transition hover:opacity-90 disabled:opacity-40 active:scale-[0.99]"
              style={{ backgroundColor: confirmed ? "#059669" : "rgba(13,17,68,0.2)" }}
            >
